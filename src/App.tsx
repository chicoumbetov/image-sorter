...
import ObjectDetection from "./ObjectDetection.tsx";
import PdfToXlsConverter from "./pdf-to-xls/pdfToXlsConverter.tsx";
...
const App = () => {
  ...
  const identify = async (props: any) => {
                ...
                return (
                  <div className="result" key={result[0]?.score}>
                    ...
                    <span className="confidence">
                      Confidence level: {(result[0]?.score * 100).toFixed(2)}%{" "}
                      {index === 0 && (
